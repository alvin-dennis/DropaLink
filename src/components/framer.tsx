...
const MotionNav = React.forwardRef<HTMLElement, HTMLMotionProps<"nav">>(function MotionNav(
  { children, ...props },
  ref,
) {
  return (
...
const MotionBQ = React.forwardRef<HTMLQuoteElement, HTMLMotionProps<"blockquote">>(
